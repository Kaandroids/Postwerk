...
export const LP2_MKT_CARDS: MarketCard[] = [
  ...
  { cat: 'HR', title: { de: 'Bewerbungs-Pipeline', en: 'Hiring pipeline' }, desc: { de: 'Sortiert Bewerbungen, plant Erstgespräche und hält Kandidaten automatisch auf dem Laufenden.', en: 'Sorts applications, schedules first calls and keeps candidates updated automatically.' }, by: 'Jonas W.', av: 'JW', grad: 'linear-gradient(135deg,#e8e0d2,#a89e8a)' },
  ...
  { cat: 'Reporting', title: { de: 'Wochen-Digest', en: 'Weekly digest' }, desc: { de: 'Sammelt Kennzahlen aus Ihren Tools und schickt montags einen kompakten Bericht an die Geschäftsführung.', en: 'Collects metrics from your tools and sends a compact Monday report to leadership.' }, by: 'Tom R.', av: 'TR', grad: 'linear-gradient(135deg,#f0d4d4,#c98d8d)' },
];
